...
import { createQuantizationChartConfig } from "../../utils/chartConfigs.js";
import { ChartCanvas } from "../common/ChartCanvas.jsx";
import { EmptyChart } from "../common/EmptyChart.jsx";

export function PricePerformanceChart({ benchmarkResults }) {
  const chartData = useMemo(
    () => createQuantizationChartConfig(benchmarkResults),
    [benchmarkResults]
  );
